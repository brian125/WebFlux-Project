package co.com.sofka.springbootwebflux.controllers;
...
public class ProductoController {
    ...
    public Mono<String> crear(Model model){
        ...
        model.addAttribute("boton", "Nuevo producto");
        ...
        if(result.hasErrors()){
            ...
            return categoria.flatMap(c -> {
               ...
               return service.save(producto);
                ...
                log.info("Catgoria asignada: " + producto.getCategoria().getNombre() + " Id Categoria: " + producto.getCategoria().getId());
